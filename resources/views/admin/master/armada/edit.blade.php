                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group date">
                                            <input type="date" class="form-control" value=" {{old('laststnk') ?? $armada->laststnk }} " placeholder="Select date" name="laststnk">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group date">
                                            <input type="date" class="form-control" value=" {{old('futurestnk') ?? $armada->futurestnk }} " placeholder="Select date" name="futurestnk">
