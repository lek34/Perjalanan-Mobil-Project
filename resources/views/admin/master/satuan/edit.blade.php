    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Form Satuan</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-5">
                    ...
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                        action="{{ route('admin.master.satuan.update',$satuan->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!--begin::Input group-->
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button class="btn btn-light me-3"><a
                                    href="{{ route('admin.master.satuan.index') }}">Cancel</a></button>
                            <!--end::Button-->
                            <!--begin::Button-->
